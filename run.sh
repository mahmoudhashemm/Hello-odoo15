...
git clone --depth=1 https://github.com/mahmoudhashemm/Hello-odoo15.git $DESTINATION
...
git clone --depth 1 --branch master git@github.com:mahmoudhashemm/pro-odoo-15 "$DESTINATION/enterprise"
